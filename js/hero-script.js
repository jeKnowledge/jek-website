...
window.onscroll = function() {
  if (window.scrollY > document.querySelector(".c-hero-ov-action").offsetTop - 24) {
    ...
    document.querySelector(".c-hero-ov-4").style.transform = "translateX(" + actionDisplaceMenu + "px)";
    ...
    if(window.screen.width>400){
      if((window.scrollY > document.querySelector(".c-hero-ov-action").offsetTop + 850 || window.scrollY < document.querySelector(".c-hero-ov-action").offsetTop + 800 || window.scrollY < document.querySelector(".c-hero-ov-action").offsetTop + 600) && nav==0){
